...
1. 对自己的OS kernel Comp实验专用仓库进行编程，逐步实现对各种Linux Syscall的支持。有问题就发[issues](https://github.com/oscomp/starry-next/issues)，并可在四阶段项目一群中交流。
1. 登顶[支持Linux App宏内核的编程排行榜](https://learningos.cn/oscomptest-grading)
